...
% statistics calculations move to an external function called
% GetDistributionStatsRev5.m and the idea is to separate the two functions
% to allow calculation of these values without having to plot the result if
% desired
