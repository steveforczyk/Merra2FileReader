function ReadDataset01(nowFile,nowpath)
% Modified: This function will read in the the Merra-2 data set 01
% This dataset is of the item M2IUNXASM_5.12.4
% Written By: Stephen Forczyk
% Created: Aug 2,2022
% Revised: May 13,2023 begin real work on this decoder
% Revised: May 23,2023 started commouting basic stats for data and
%          creating tables (ikind=4 and 5)
% Revised: May 24,2023 added more variables for stats 
% Revised: May 31,2023 continued to add more tables
% Revised: Jun 02,2023 added table TS
% Revised: Jun 03,2023 added Tables for U10 U2 U50 and V components
...
DISPHS=struct('values',[],'long_name',[],'units',[],'FillValue',[],...
...
for i = 0:numvars-1
    ...
    flag = 0;
    for j = 0:numatts - 1
       a10=strcmp(varname,'DISPH');
       a20=strcmp(varname,'lat');
       a30=strcmp(varname,'lon');
       a40=strcmp(varname,'PS');
       a50=strcmp(varname,'QV10M');
       a60=strcmp(varname,'QV2M');
       ...
       if (a10==1)
            ...
            if(a1==1)
                DISPHS.long_name=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                DISPHS.FillValue=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                DISPHS.units=attname2;
            end
            a1=strcmp(attname1,'missing_value');
            if(a1==1)
                DISPHS.missing_value=attname2;
            end
            a1=strcmp(attname1,'fmissing_value');
            if(a1==1)
                DISPHS.fmissing_value=attname2;
            end
            a1=strcmp(attname1,'vmax');
            if(a1==1)
                DISPHS.vmax=attname2;
            end
            a1=strcmp(attname1,'vmin');
            if(a1==1)
                DISPHS.vmin=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                DISPHS.valid_range=attname2;
            end
       ...
       elseif (a40==1)
            ...
            if(framecounter==1)
                PS10=zeros(numSelectedFiles,1);
                PS25=zeros(numSelectedFiles,1);
                PS50=zeros(numSelectedFiles,1);
                PS75=zeros(numSelectedFiles,1);
                PS90=zeros(numSelectedFiles,1);
                PS100=zeros(numSelectedFiles,1);
                PSLow=zeros(numSelectedFiles,1);
                PSHigh=zeros(numSelectedFiles,1);
                PSNaN=zeros(numSelectedFiles,1);
            end
          ...
          elseif (a50==1)
            ...
            if(framecounter==1)
                QV10M10=zeros(numSelectedFiles,1);
                ...
                QV10MLow=zeros(numSelectedFiles,1);
                QV10MHigh=zeros(numSelectedFiles,1);
          ...
          elseif (a60==1)
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                QV2MS.long_name=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                QV2MS.FillValue=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                QV2MS.units=attname2;
            end
            a1=strcmp(attname1,'missing_value');
            if(a1==1)
                QV2MS.missing_value=attname2;
            end
            a1=strcmp(attname1,'fmissing_value');
            if(a1==1)
                QV2MS.fmissing_value=attname2;
            end
            a1=strcmp(attname1,'vmax');
            if(a1==1)
                QV2MS.vmax=attname2;
            ...
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                QV2MS.valid_range=attname2;
            end
            if(framecounter==1)
                QV2M10=zeros(numSelectedFiles,1);
                QV2M25=zeros(numSelectedFiles,1);
                QV2M50=zeros(numSelectedFiles,1);
                QV2M75=zeros(numSelectedFiles,1);
                QV2M90=zeros(numSelectedFiles,1);
                QV2M100=zeros(numSelectedFiles,1);
                QV2MLow=zeros(numSelectedFiles,1);
                QV2MHigh=zeros(numSelectedFiles,1);
                QV2MNaN=zeros(numSelectedFiles,1);
            end
