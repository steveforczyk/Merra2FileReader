function PlotTSTable(titlestr,ikind,iAddToReport,iNewChapter,iCloseChapter)
...
plot(TSTT.Time,TSTT.TS10,'b',TSTT.Time,TSTT.TS50,'g',...
    TSTT.Time,TSTT.TS70,'c',TSTT.Time,TSTT.TS90,'r');
set(gcf,'Position',[hor1 vert1 widd lend])
set(gca,'FontWeight','bold');
set(gca,'XGrid','on','YGrid','on');
hl=legend('TS 10 ptile','TS 50 ptile','TS 70 ptile','TS 90 ptile');
ht=title(titlestr);
xlabel('Date','FontWeight','bold','FontSize',12);
ylabelstr='TS';
ylabel('Monthly Skin Temp','FontWeight','bold','FontSize',12);
% Add a logo
if(iLogo==1)
...
% variable being plotted
    ...
    parastr2='This metric is a monthly average of skin temperature.';
