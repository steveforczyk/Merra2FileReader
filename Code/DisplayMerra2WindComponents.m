function  DisplayMerra2WindComponents(Stats,WindAdj,fracNaN,ikind,iProj,titlestr)
...
% Revised: Mar 2,2024 added Africa Detailed Map
% Revised: Mar 5,2024 added Australia detailed map
...
elseif(iProj==2)% Default World Mercator Map
