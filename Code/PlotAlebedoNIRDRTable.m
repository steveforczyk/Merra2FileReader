function PlotAlebedoNIRDRTable(titlestr,ikind,iAddToReport,iNewChapter,iCloseChapter)
% This function is plotting the Surface NearIR Beam Table Values
...
plot(AlbnirdrTT.Time,AlbnirdrTT.Albnirdr10,'b',AlbnirdrTT.Time,AlbnirdrTT.Albnirdr50,'g',...
    AlbnirdrTT.Time,AlbnirdrTT.Albnirdr70,'c',AlbnirdrTT.Time,AlbnirdrTT.Albnirdr90,'r');
set(gcf,'Position',[hor1 vert1 widd lend])
set(gca,'FontWeight','bold');
set(gca,'XGrid','on','YGrid','on');
hl=legend('Albnirdr 10 ptile','Albnirdr 50 ptile','Albnirdr 70 ptile','Albnirdr 90 ptile');
ht=title(titlestr);
xlabel('Date','FontWeight','bold','FontSize',12);
ylabelstr='Albnirdr';
ylabel('Monthly Albnirdr Average','FontWeight','bold','FontSize',12);
% Add a logo
if(iLogo==1)
...
if((iCreatePDFReport==1) && (RptGenPresent==1)  && (iAddToReport==1))
    ...
    sectionstr=strcat('ALBEDONIRDR','-Map');
...
% variable being plotted
    ...
    parastr2='This metric is a monthly average of the surface NIR Beam albedo.';
