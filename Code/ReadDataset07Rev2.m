function ReadDataset07Rev2(nowFile,nowpath)
...
%% Now read the valuesB 
%ncid = netcdf.open(nowFile);
clear B U10 V10 T10
B=ncstruct(nowFile, 'U', 'V','T', 'dimensions');
U10=B.U;
V10=B.V;
T10=B.T;
ab=1;
