function [val01,val25,val50,val75,val90,val100,fraclow,frachigh,fracgood,fracNaN] = GetWDistributionStats(inArray,lowcutoff,highcutoff)
...
global sumMaskArea RasterAreaGrid;
...
[ihigh01]=find(Fixed1DCumilAreas>=.01);
num01=ihigh01(1);
val01=Fixed1DSortArray(num01,1);
[ihigh25]=find(Fixed1DCumilAreas>=.25);
num25=ihigh25(1);
val25=Fixed1DSortArray(num25,1);
[ihigh50]=find(Fixed1DCumilAreas>=.50);
num50=ihigh50(1);
val50=Fixed1DSortArray(num50,1);
[ihigh75]=find(Fixed1DCumilAreas>=.75);
num75=ihigh75(1);
val75=Fixed1DSortArray(num75,1);
[ihigh90]=find(Fixed1DCumilAreas>=.90);
num90=ihigh90(1);
val90=Fixed1DSortArray(num90,1);
num100=numgood;
val100=Fixed1DSortArray(numgood,1);
ab=3;
val01=val01-273.15;
val25=val25-273.15;
val50=val50-273.15;
